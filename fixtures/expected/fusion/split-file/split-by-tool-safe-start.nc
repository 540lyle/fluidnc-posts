...
(Load tool number 1 and subprogram split-by-tool-safe-start_1_T1)
(Load tool number 2 and subprogram split-by-tool-safe-start_2_T2)
(Load tool number 1 and subprogram split-by-tool-safe-start_3_T1)
